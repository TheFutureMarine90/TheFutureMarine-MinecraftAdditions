...
public class BlockAcaciaBookshelf extends Block implements IHasModel
{

    public BlockAcaciaBookshelf(String name, Material material)
    {
        super(material);
    ...
    {
        {
            return this == BlockInit.AcaciaBookshelf ? 1 : 0;
        }
    }
}
