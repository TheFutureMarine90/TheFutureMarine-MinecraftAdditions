...
public class BlockBirchBookshelf extends Block implements IHasModel
{

    public BlockBirchBookshelf(String name, Material material)
    {
        super(material);
    ...
    {
        {
            return this == BlockInit.BirchBookshelf ? 1 : 0;
        }
    }
}