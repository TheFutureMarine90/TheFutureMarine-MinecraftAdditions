...
public class BlockSpruceBookshelf extends Block implements IHasModel
{

    public BlockSpruceBookshelf(String name, Material material)
    {
        super(material);
    ...
    {
        {
            return this == BlockInit.SpruceBookshelf ? 1 : 0;
        }
    }
}
