...
public class BlockJungleBookshelf extends Block implements IHasModel
{

    public BlockJungleBookshelf(String name, Material material)
    {
        super(material);
    ...
    {
        {
            return this == BlockInit.JungleBookshelf ? 1 : 0;
        }
    }
}
